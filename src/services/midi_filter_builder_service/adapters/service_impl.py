...
from midifilter.filters import MidiFilter, VelocityRangeFilter, NoteRangeFilter, TransposeFilter, \
    ControllerChangeFilter, ProgramChangeFilter
...
class MidiFilterBuilderServiceImpl(MidiFilterBuilderService):
    def __init__(self):
        self.notes_queue = []
